...
export const testUserModel = {
    ...
    // FIXED: Only check user_oauth_providers table
    ...
    // FIXED: Create user without OAuth columns, then link OAuth provider
    ...
    // FIXED: Get user without OAuth columns, add placeholder values
    ...
    // NEW: Helper method to link OAuth provider to existing user
    ...
    // NEW: Helper method to unlink OAuth provider
    ...
    // NEW: Check if user has password authentication
