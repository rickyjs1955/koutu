// /backend/src/utils/testImageService.v2.ts - DUAL-MODE VERSION
/**
 * Dual-Mode Test Image Service
 * 
 * This version automatically uses the correct database connection based on
 * the dual-mode infrastructure (Docker vs Manual).
 * 
 * Maintains identical API to original testImageService.ts but uses the
