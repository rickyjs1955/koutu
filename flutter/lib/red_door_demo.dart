...
class _RedDoorSplashState extends State<RedDoorSplash>
  ...
  void initState() {
    ...
    _controller.addListener(() {
      print('Animation progress: ${(_controller.value * 100).toStringAsFixed(0)}%');
      print('Left door: ${_leftDoorAnimation.value.toStringAsFixed(1)}°');
      print('Right door: ${_rightDoorAnimation.value.toStringAsFixed(1)}°');
      print('---');
    });
  }
